...
class HomeVC: UIViewController {
    ...
    var popularDish: [Dish] = [
        ...
        .init(id: "1", name: "Chiyano", description: "Fav Dish is hereFav", image: "image3", calorie: 20.897869),
        .init(id: "2", name: "Fercanius", description: "This is the best I have ever had", image: "image3", calorie: 40.897869)
    ]
